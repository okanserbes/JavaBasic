...
public class Registration {
	...
	public void setEmail(String email) {
		...
		if (email.endsWith("yahoo.com"))
		{
			...
			System.out.println("This is not yahoo mail.");
		}
	...
	public void setPassword(String password) {
		...
		if(!password.contains(userName) &&  password.length() > 6 && !password.isEmpty()) {
			this.password = password;
			
		}
		else {
			
			System.out.println("You cannot use your username in password");
		}
